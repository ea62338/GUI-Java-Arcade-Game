...
public abstract class Game extends Region {
    ...
    protected final Bounds bounds;                     // game bounds
    private final Duration fpsTarget;                // target duration for game loop
    protected final Timeline loop = new Timeline();    // timeline for main game loop
    protected final BitSet keysPressed = new BitSet(); // set of currently pressed keys
    ...
    public Game(int width, int height, int fps) {
        ...
        this.fpsTarget = Duration.millis(5000.0 / fps);
